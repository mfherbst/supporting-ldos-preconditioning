...
config[@__DIR__] = (
    ...
    case="GaAsVac",
    n_repeat=20,
    kwargs_scf=(kspacing=0.15, find_occupation=DFTK.find_occupation_bandgap, ),
    firstmixkey="Custom",
    #
    construct_localiser=construct_localiser_GaAsVac,
    mixings=Dict(
